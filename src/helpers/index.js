...
export function getProviderInfoFromChecksArray(checks) {
  const check = filterProviderChecks(checks);
  return filterProviders("check", check);
}

export function getProviderInfoByName(name) {
  return filterProviders("name", name);
}

export function getProviderInfoById(id) {
  return filterProviders("id", id);
}

export function getProviderInfoByCheck(check) {
  return filterProviders("check", check);
}
...
export function filterProviders(param, value) {
...
export function filterProviderChecks(checks) {
